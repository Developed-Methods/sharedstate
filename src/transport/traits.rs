...
pub trait SyncIOAddress: Debug + Clone + Copy + Send + Sync + PartialEq + Eq + Ord + Hash + 'static {}

impl<T: Debug + Clone + Copy + Send + Sync + PartialEq + Eq + Ord + Hash + 'static> SyncIOAddress for T {}
